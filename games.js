function games(currDockIcon){
    ...
    if(!currDockIcon.querySelector('.active-dot')){
            ...
            divDot.setAttribute('appBox-dot','Games-dot');
    ...
    //Z-INdex                  
    let currBox = document.querySelector('.box-box[appbox="Games"]');
    if(currBox){
        currDockIcon.addEventListener("click",function(){

            if(lastZIndexAppBOx != lastZIndexAppBOx!='Games' ){
